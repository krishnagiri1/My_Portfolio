...
const WORDS = ["Data Science Master's Student", "Machine Learning Enthusiast", "Python & SQL Developer"];
const TECH_STACK = ["Python", "SQL", "TensorFlow", "Scikit-Learn"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/krishnagiri1" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/venkata-krishna-giri-koneru-6625101a9/" },
  { icon: Mail, link: "mailto:kvkgiri01@gmail.com" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Passionate about solving real-world problems through Data Science, ML, and scalable deployment solutions.
                </p>
